...
export const SEED_ITINERARIES: Itinerary[] = [
  { id: 'CPS5678', reference: 'CPS5678', itineraryRef: 'ITN-10234', title: 'Families Apex, Tiffany, Zidane', agency: 'Zoo Groups', agent: '', agencyAddress: '14 Wildlife Lane, Nairobi, Kenya', safariPlanner: 'Amelia Earhart', destination: 'Tanzania', travelDateFrom: '2026-08-02', travelDateTo: '2026-08-14', createdAt: '2026-06-01', status: 'DRAFT', paymentStatus: 'UNPAID', totalUsd: 12500, balanceUsd: 12500, updatedAt: '2026-07-08T09:12:00Z', adults: 2, children: 2, infants: 0 },
  { id: 'CPS5678-1', reference: 'CPS5678-1', itineraryRef: 'ITN-10234-1', title: 'Delacroix Family', agency: 'Zoo Groups', agent: '', agencyAddress: '14 Wildlife Lane, Nairobi, Kenya', safariPlanner: 'Amelia Earhart', destination: 'Tanzania', travelDateFrom: '2026-08-02', travelDateTo: '2026-08-14', createdAt: '2026-06-01', status: 'DRAFT', paymentStatus: 'UNPAID', totalUsd: 118000, balanceUsd: 118000, updatedAt: '2026-07-08T09:12:00Z', adults: 4, children: 2, infants: 0 },
  { id: 'CPS5678-1-1', reference: 'CPS5678-1-1', itineraryRef: 'ITN-10234-1-1', title: 'Delacroix — Grandparents', agency: 'Zoo Groups', agent: '', agencyAddress: '14 Wildlife Lane, Nairobi, Kenya', safariPlanner: 'Amelia Earhart', destination: 'Tanzania', travelDateFrom: '2026-08-02', travelDateTo: '2026-08-14', createdAt: '2026-06-01', status: 'VOUCHERED', paymentStatus: 'DEPOSIT_PAID', totalUsd: 62000, balanceUsd: 42000, updatedAt: '2026-07-08T09:12:00Z', adults: 2, children: 0, infants: 0, supplierVouchers: { 'pe-elewana-tz': 'Raised' }, voucherMeta: { 'pe-elewana-tz': { issued: false, issuedTo: [], tokens: [], resendCount: 0, version: 0, voucherSeq: 1, voucherRef: 'CPS5678-1-1 / V01' } } },
  { id: 'CPS5678-1-2', reference: 'CPS5678-1-2', itineraryRef: 'ITN-10234-1-2', title: 'Delacroix — Children', agency: 'Zoo Groups', agent: '', agencyAddress: '14 Wildlife Lane, Nairobi, Kenya', safariPlanner: 'Amelia Earhart', destination: 'Tanzania', travelDateFrom: '2026-08-02', travelDateTo: '2026-08-14', createdAt: '2026-06-01', status: 'DRAFT', paymentStatus: 'UNPAID', totalUsd: 56000, balanceUsd: 56000, updatedAt: '2026-07-08T09:12:00Z', adults: 2, children: 2, infants: 0 },
  { id: 'CPS5678-2', reference: 'CPS5678-2', itineraryRef: 'ITN-10234-2', title: 'Moreau Family', agency: 'Zoo Groups', agent: '', agencyAddress: '14 Wildlife Lane, Nairobi, Kenya', safariPlanner: 'Amelia Earhart', destination: 'Tanzania', travelDateFrom: '2026-08-02', travelDateTo: '2026-08-14', createdAt: '2026-06-01', status: 'DRAFT', paymentStatus: 'UNPAID', totalUsd: 126000, balanceUsd: 126000, updatedAt: '2026-07-08T09:12:00Z', adults: 2, children: 1, infants: 0 },
  { id: 'CPS5679', reference: 'CPS5679', itineraryRef: 'ITN-10235', title: 'Wanderlust Family Kenya Explorer', agency: 'Zoo Groups', agent: 'David Ochieng', agencyAddress: '14 Wildlife Lane, Nairobi, Kenya', safariPlanner: 'Amelia Earhart', destination: 'Kenya', travelDateFrom: '2026-08-02', travelDateTo: '2026-08-14', createdAt: '2026-06-15', status: 'PREPARED', paymentStatus: 'DEPOSIT_PAID', totalUsd: 18200, balanceUsd: 14200, updatedAt: '2026-07-07T15:40:00Z', adults: 2, children: 3, infants: 0 },
  { id: 'CPS5680', reference: 'CPS5680', itineraryRef: 'ITN-10236', title: 'Baobab Migration Adventure', agency: 'CPS', agent: '', agencyAddress: 'Fedha Towers, Muindi Mbingu Street, Nairobi, Kenya', safariPlanner: 'Noah Kiptoo', destination: 'Tanzania', travelDateFrom: '2026-09-05', travelDateTo: '2026-09-15', createdAt: '2026-06-20', status: 'QUOTED', paymentStatus: 'OVERPAID', totalUsd: 10200, balanceUsd: -450, updatedAt: '2026-07-06T11:05:00Z', adults: 4, children: 0, infants: 0, creditTerms: true },
  { id: 'CPS5681', reference: 'CPS5681', itineraryRef: 'ITN-10237', title: 'Apex Voyages Serengeti Fly-In', agency: 'Black Tomato', agent: 'Rachel Kim', agencyAddress: '30 Great Guildford Street, London SE1 0HS, United Kingdom', safariPlanner: 'Amelia Earhart', destination: 'Tanzania', travelDateFrom: '2026-07-20', travelDateTo: '2026-07-28', createdAt: '2026-06-22', status: 'APPROVED', paymentStatus: 'PARTIALLY_PAID', totalUsd: 15600, balanceUsd: 7800, updatedAt: '2026-07-05T08:22:00Z', adults: 2, children: 0, infants: 0 },
  { id: 'CPS5682', reference: 'CPS5682', itineraryRef: 'ITN-10238', title: 'Safari Dreams Honeymoon Escape', agency: 'Zoo Groups', agent: 'Peter Mwangi', agencyAddress: '14 Wildlife Lane, Nairobi, Kenya', safariPlanner: 'Noah Kiptoo', destination: 'Kenya', travelDateFrom: '2026-06-01', travelDateTo: '2026-06-09', createdAt: '2026-05-10', status: 'CONFIRMED', paymentStatus: 'FULLY_PAID', totalUsd: 9800, balanceUsd: 0, updatedAt: '2026-07-04T17:50:00Z', adults: 2, children: 0, infants: 0 },
  { id: 'CPS5683', reference: 'CPS5683', itineraryRef: 'ITN-10239', title: 'Cheli & Peacock VIP Group Tour', agency: 'CPS', agent: '', agencyAddress: 'Fedha Towers, Muindi Mbingu Street, Nairobi, Kenya', safariPlanner: 'Amelia Earhart', destination: 'Tanzania', travelDateFrom: '2026-05-14', travelDateTo: '2026-05-24', createdAt: '2026-04-18', status: 'TRAVEL_IN_PROGRESS', paymentStatus: 'FULLY_PAID', totalUsd: 32000, balanceUsd: 0, updatedAt: '2026-07-08T06:15:00Z', adults: 6, children: 0, infants: 0 },
  { id: 'CPS5684', reference: 'CPS5684', itineraryRef: 'ITN-10240', title: 'Elewana Zanzibar Beach Extension', agency: 'Black Tomato', agent: 'Jane Smith', agencyAddress: '30 Great Guildford Street, London SE1 0HS, United Kingdom', safariPlanner: 'Noah Kiptoo', destination: 'Zanzibar', travelDateFrom: '2026-03-02', travelDateTo: '2026-03-09', createdAt: '2026-02-01', status: 'COMPLETED', paymentStatus: 'FULLY_PAID', totalUsd: 6400, balanceUsd: 0, updatedAt: '2026-06-20T10:00:00Z', adults: 2, children: 0, infants: 0 },
  { id: 'CPS5686', reference: 'CPS5686', itineraryRef: 'ITN-10242', title: 'Smith Family', agency: 'Black Tomato', agent: '', agencyAddress: '30 Great Guildford Street, London SE1 0HS, United Kingdom', safariPlanner: 'Amelia Earhart', destination: 'Kenya', travelDateFrom: '2026-06-10', travelDateTo: '2026-06-20', createdAt: '2026-05-20', status: 'DRAFT', paymentStatus: 'UNPAID', totalUsd: 18200, balanceUsd: 18200, updatedAt: '2026-07-08T09:12:00Z', adults: 2, children: 2, infants: 0 },
  { id: 'CPS5686-1', reference: 'CPS5686-1', itineraryRef: 'ITN-10242-1', title: 'Whitfield Family', agency: 'Black Tomato', agent: '', agencyAddress: '30 Great Guildford Street, London SE1 0HS, United Kingdom', safariPlanner: 'Amelia Earhart', destination: 'Kenya', travelDateFrom: '2026-06-10', travelDateTo: '2026-06-20', createdAt: '2026-05-20', status: 'CONFIRMED', paymentStatus: 'UNPAID', totalUsd: 18200, balanceUsd: 18200, updatedAt: '2026-07-08T09:12:00Z', adults: 2, children: 1, infants: 0 },
  { id: 'CPS5686-2', reference: 'CPS5686-2', itineraryRef: 'ITN-10242-2', title: 'Okonkwo Family', agency: 'Black Tomato', agent: '', agencyAddress: '30 Great Guildford Street, London SE1 0HS, United Kingdom', safariPlanner: 'Amelia Earhart', destination: 'Kenya', travelDateFrom: '2026-06-10', travelDateTo: '2026-06-20', createdAt: '2026-05-20', status: 'SUPERSEDED', paymentStatus: 'UNPAID', totalUsd: 12500, balanceUsd: 12500, updatedAt: '2026-07-08T09:12:00Z', adults: 2, children: 0, infants: 1 },
  { id: 'CPS5686-3', reference: 'CPS5686-3', itineraryRef: 'ITN-10242-3', title: 'Patel Family', agency: 'Black Tomato', agent: '', agencyAddress: '30 Great Guildford Street, London SE1 0HS, United Kingdom', safariPlanner: 'Amelia Earhart', destination: 'Kenya', travelDateFrom: '2026-06-10', travelDateTo: '2026-06-20', createdAt: '2026-05-20', status: 'SUPERSEDED', paymentStatus: 'UNPAID', totalUsd: 15900, balanceUsd: 15900, updatedAt: '2026-07-08T09:12:00Z', adults: 2, children: 2, infants: 0 },
  { id: 'CPS5687', reference: 'CPS5687', itineraryRef: 'ITN-10243', title: 'Bennett Family', agency: 'CPS', agent: '', agencyAddress: 'Fedha Towers, Muindi Mbingu Street, Nairobi, Kenya', safariPlanner: 'Noah Kiptoo', destination: 'Tanzania', travelDateFrom: '2026-09-05', travelDateTo: '2026-09-12', createdAt: '2026-06-01', status: 'DRAFT', paymentStatus: 'UNPAID', totalUsd: 22000, balanceUsd: 22000, updatedAt: '2026-07-08T09:12:00Z', adults: 2, children: 2, infants: 0 },
  { id: 'CPS5687-1', reference: 'CPS5687-1', itineraryRef: 'ITN-10243-1', title: 'Bennett Family', agency: 'CPS', agent: '', agencyAddress: 'Fedha Towers, Muindi Mbingu Street, Nairobi, Kenya', safariPlanner: 'Noah Kiptoo', destination: 'Tanzania', travelDateFrom: '2026-09-05', travelDateTo: '2026-09-12', createdAt: '2026-06-01', status: 'DRAFT', paymentStatus: 'UNPAID', totalUsd: 22000, balanceUsd: 22000, updatedAt: '2026-07-08T09:12:00Z', adults: 2, children: 2, infants: 0 },
  { id: 'CPS5688', reference: 'CPS5688', itineraryRef: 'ITN-10244', title: 'Elewana Kenya & Tanzania Safari', agency: 'CPS', agent: '', agencyAddress: 'Fedha Towers, Muindi Mbingu Street, Nairobi, Kenya', safariPlanner: 'Amelia Earhart', destination: 'Kenya', travelDateFrom: '2026-09-01', travelDateTo: '2026-09-15', createdAt: '2026-07-01', status: 'DRAFT', paymentStatus: 'UNPAID', totalUsd: 42140.96, balanceUsd: 42140.96, updatedAt: '2026-07-20T10:00:00Z', adults: 2, children: 2, infants: 0 },
  { id: 'CPS5685', reference: 'CPS5685', itineraryRef: 'ITN-10241', title: 'Untitled Itinerary', agency: 'Zoo Groups', agent: 'David Ochieng', agencyAddress: '14 Wildlife Lane, Nairobi, Kenya', safariPlanner: 'Amelia Earhart', destination: 'Kenya', travelDateFrom: '2026-10-11', travelDateTo: '2026-10-18', createdAt: '2026-06-25', status: 'CANCELLED', paymentStatus: 'REFUND_PENDING', totalUsd: 11200, balanceUsd: -3200, updatedAt: '2026-06-28T13:33:00Z', adults: 2, children: 1, infants: 0 },
  { id: 'CPS5689', reference: 'CPS5689', itineraryRef: 'ITN-10245', title: 'Thompson Kenya Safari', agency: 'Travel Counsellors UK', agent: 'Sarah Thompson', agencyAddress: 'Nottingham House, Riverside Business Park, Nottingham NG2 1RU, United Kingdom', safariPlanner: 'Amelia Earhart', destination: 'Kenya', travelDateFrom: '2026-10-05', travelDateTo: '2026-10-14', createdAt: '2026-07-10', status: 'APPROVED', paymentStatus: 'UNPAID', totalUsd: 14200, balanceUsd: 14200, updatedAt: '2026-07-12T10:00:00Z', adults: 2, children: 0, infants: 0 },
]
