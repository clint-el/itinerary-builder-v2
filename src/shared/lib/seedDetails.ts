  ...
  return [
    ...
    serviceCard(
      ...
      [
        ...
        { label: 'Date', value: formatRange('2026-09-03', '2026-09-03') },
        { label: 'Depart / Return', value: '08:30' },
      ...
      ],
      {
        ...
        fareLines: [
          { route: 'WIL – LOI', pax: 2, adult: 2, youth: 0, child: 0, infant: 0, net: 534.5, rack: sellFromNet(534.5, 27.96) },
          { route: 'WIL – LOI (teens)', pax: 2, adult: 0, youth: 2, child: 0, infant: 0, net: 267.25, rack: sellFromNet(267.25, 28) },
        ],
        extras: [],
        customExtras: [],
        promotion: null,
    ...
    serviceCard(
      ...
      [
        ...
        { label: 'Depart / Return', value: '09:15' },
        { label: 'Pax', value: '2A, 2Y' },
      ],
      {
        location: 'Loisaba',
        ...
        fareLines: [
          { route: 'LOI – MRE', pax: 2, adult: 2, youth: 0, child: 0, infant: 0, net: 855.8, rack: sellFromNet(855.8, 27.96) },
          { route: 'LOI – MRE (teens)', pax: 2, adult: 0, youth: 2, child: 0, infant: 0, net: 427.9, rack: sellFromNet(427.9, 28) },
        ],
        extras: [],
        customExtras: [],
        promotion: null,
    ...
    serviceCard(
      ...
      [
        ...
        { label: 'Depart / Return', value: '10:00' },
        { label: 'Pax', value: '2A, 2Y' },
      ],
      {
        location: 'Masai Mara',
        ...
        fareLines: [
          { route: 'MRE – KTD', pax: 2, adult: 2, youth: 0, child: 0, infant: 0, net: 1275.8, rack: sellFromNet(1275.8, 28) },
          { route: 'MRE – KTD (teens)', pax: 2, adult: 0, youth: 2, child: 0, infant: 0, net: 637.9, rack: sellFromNet(637.9, 28) },
        ],
        extras: [],
        customExtras: [],
        promotion: null,
    ...
    serviceCard(
      ...
      [
        ...
        { label: 'Depart / Return', value: '11:30' },
        { label: 'Pax', value: '2A, 2Y' },
      ],
      {
        location: 'Serengeti',
        ...
        fareLines: [
          { route: 'SEN – LKY', pax: 2, adult: 2, youth: 0, child: 0, infant: 0, net: 465, rack: sellFromNet(465, 25) },
          { route: 'SEN – LKY (teens)', pax: 2, adult: 0, youth: 2, child: 0, infant: 0, net: 232.5, rack: sellFromNet(232.5, 25) },
        ],
        extras: [],
        customExtras: [],
        promotion: null,
    ...
    serviceCard(
      ...
      [
        ...
        { label: 'Depart / Return', value: '13:45' },
        { label: 'Pax', value: '2A, 2Y' },
      ],
      {
        location: 'Ngorongoro',
        ...
        fareLines: [
          { route: 'LKY – JRO', pax: 2, adult: 2, youth: 0, child: 0, infant: 0, net: 329, rack: sellFromNet(329, 24.89) },
          { route: 'LKY – JRO (teens)', pax: 2, adult: 0, youth: 2, child: 0, infant: 0, net: 164.5, rack: sellFromNet(164.5, 25) },
        ],
        extras: [],
        customExtras: [],
        promotion: null,
